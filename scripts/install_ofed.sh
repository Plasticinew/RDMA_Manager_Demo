...
tar -zxvf MLNX_OFED_LINUX-5.6-1.0.3.3-ubuntu22.04-x86_64.tgz

cd MLNX_OFED_LINUX-5.6-1.0.3.3-ubuntu22.04-x86_64

sudo ./mlnxofedinstall --force

cd ../; sudo rm -rf MLNX_OFED_LINUX-5.6-1.0.3.3-ubuntu22.04-x86_64*
